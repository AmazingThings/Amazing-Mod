package com.github.AmazingThings.Amazing_Mod.tileentity;
...
public class TileEntityElectricFurnace extends TileEntity implements ISidedInventory{
	...
	public void updateEntity() {
		...
		if (flag != this.furnaceBurnTime > 0) {
			flag1 = true;
			ElectricFurnace.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
		}
